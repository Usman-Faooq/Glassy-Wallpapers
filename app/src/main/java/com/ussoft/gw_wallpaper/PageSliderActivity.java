...
import com.ussoft.gw_wallpaper.adapter.PagerSliderAdapter;
...
public class PageSliderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Banner Ad
        mAdView = findViewById(R.id.SliderBanner);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        //Interstitial Ad
        InterstitialAd.load(this,"ca-app-pub-3304369012094568/4562016487", adRequest,
